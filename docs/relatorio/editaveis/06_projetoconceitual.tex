...
A Figura \ref{fig:cad_superior} mostra a vista superior do primeiro nível do micromouse, na qual são identificados a placa de componentes eletrônicos: o microcontrolador Raspberry Pi Pico W, a ponte H TB6612FNG, os sensores infravermelhos VL53L0X e o ultrassônico HC-SR04 e o giroscópio MPU-6050. Os sensores frontais estão posicionados de forma a cobrir as três direções de interesse para a navegação: frente, esquerda e direita, conforme requerido pelo algoritmo de flood-fill descrito na Seção 6.5. Além disso, pode-se identificar os dois motores N20, fixados por abraçadeiras em U e as rodas em seus respectivos eixos.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{figuras/esquematico_esp32.png}
...
%=========================================================================================    
    ...
    Na visão de processos, descreve-se como os componentes lógicos são realizados em tasks, threads ou processos em tempo de execução, considerando seus períodos, prioridades e mecanismos de sincronização. No firmware embarcado, o Raspberry Pi Pico W possui dois núcleos no RP2040, identificados como Core 0 e Core 1. Como decisão de projeto, a carga é distribuída de modo que o Core 1 execute as tarefas de tempo real, incluindo aquisição de sensores, algoritmo de navegação flood-fill e uma ISR de timer dedicada ao controle dos motores, com frequência entre 1 e 5 kHz, ainda a calibrar. O uso de ISR para o controle isola essa rotina do scheduler do FreeRTOS, garantindo frequência fixa. Já o Core 0 executa as tarefas de comunicação, incluindo a stack Wi-Fi do módulo CYW43439, acessado por SPI, o cliente MQTT publisher e a tarefa de telemetria. Essa separação isola o caminho crítico de controle das latências variáveis da comunicação sem fio.
