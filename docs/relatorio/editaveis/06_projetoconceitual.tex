...
Abaixo estão alguns dos casos de testes que serão feitos para verificação e validação do desenvolvimento do micromouse. O link mostra todos os casos de testes com as suas carateiristicas e especificações mostradas na pages do GitHub.

Gitpages: \url{https://fcte-pi1.github.io/2026_1_PI1_Grupo02_Juliana}
