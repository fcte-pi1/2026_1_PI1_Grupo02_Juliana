...
A Figura \ref{fig:cad_iso} apresenta a vista isométrica do assembly do micromouse, na qual é possível observar as baterias de 3,7 V presas com uma abraçadeira no segundo nível e a separação entre os níveis. A Figura \ref{fig:cad_superior} mostra a vista superior do primeiro nível, na qual são identificados a placa de componentes eletrônicos: o microcontrolador Raspberry Pi Pico W, a ponte H TB6612FNG, os sensores infravermelhos VL53L0X e o ultrassônico HC-SR04 e o giroscópio MPU-6050. Os sensores frontais estão posicionados de forma a cobrir as três direções de interesse para a navegação: frente, esquerda e direita, conforme requerido pelo algoritmo de flood-fill descrito na Seção 6.5. Além disso, pode-se identificar os dois motores N20, fixados por abraçadeiras em U e as rodas em seus respectivos eixos.

\begin{figure}[H]
    \centering
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figuras/rendermouse_isometrico.jpg}
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figuras/rendermouse_topview.jpg}
        \caption{Vista superior do primeiro nível.}
        \label{fig:cad_superior}
    \end{subfigure}
    \caption{CAD do assembly do micromouse.}
