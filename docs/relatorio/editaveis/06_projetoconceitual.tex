...
A estrutura mecânica do micromouse foi desenhada em {\itshape Computer-Aided Design (CAD)} no software Catia V5, com o objetivo de acomodar todos os componentes eletrônicos, motores e baterias em um volume compatível com as dimensões máximas previstas pelo regulamento IEEE Micromouse (25\,cm de comprimento e 25\,cm de largura).

Atualmente, o micromouse possui dois níveis/andares para comportar confortavelmente as partes necessárias. A ideia inicial era que o chassi fosse composto por apenas um nível com todos os componentes, mas adicioná-los todos juntos faria com que ficassem apertados ou que as dimensões do robô ficassem grandes, e não queriamos comprometer a mobilidade, arriscando curvas apertadas. Logo, decidiu-se fazê-lo com dois níveis de chassi, com espessura de 4 mm cada. No primeiro nível encontram-se os dois motores N20 com encoders de 6V cada, as rodas, a placa de componentes eletrônicos e a esfera deslizante da frente. No segundo nível, estão as duas baterias de 3,7 V.

Mesmo com o segundo nível, tentou-se manter o centro de gravidade do micromouse centralizado e o mais baixo possível, para que houvesse mais estabilidade e aderência do robô ao chão e minimizasse tombos. Assim, o chassi inferior está a 1,4 cm do chão, os espaçadores de nível têm 3 cm de altura e a bateria tem 2 cm de altura, logo soma-se um total de aproximadamente 7,5 cm altura em relação ao chão.

As rodas e a esfera deslizante foram escolhidas a fim de nivelar o micromouse. O eixo do motor que conecta nas rodas está a 5 mm do chassi, e, com um rebaixo de 1 mm para comportar o motor no chassi de 4 mm (então motor numa área do chassi de 3 mm de profundidade), temos que uma roda de 22 mm de raio eleva o micromouse de 22 - 5 - 3 = 14 mm. A esfera deslizante, que fica na frente do micromouse, tem 15 mm de altura, portanto, também foi necessário um pocket por debaixo do chassi inferior na região da esfera com a profundidade de 1 mm, transformando a elevação da frente do micromouse também em 14 mm, nivelando perfeitamente o robô.

A esfera deslizante é fixada no chassi por parafusos M3 (3 mm de diâmetro por 15 mm de profundidade). Já os espaçadores de nível são peças de nylon hexagonais com círculo circunscrito de diâmetro 5,6 mm e rosca de parafusos M3 (3 mm de diâmetro por 6 mm de profundidade), tendo ambos as roscas fêmea e macho, que serão complementadas por um parafuso M3 no chassi inferior e um inserto de latão no chassi superior. Os insertos de latão utilizados são peças serrilhadas termofixáveis que possuem rosca interna para facilitar a parafusação no chassi impresso em filamento. Eles são instalados com o leve aquecimento dos furos do chassi com um ferro de solda e a inserção. Para isso, é também necessário aumentar o diâmetro dos furos a serem impressos, dado que a peça possui espessura além do diâmetro da rosca interna, assim transformando os furos de 2 mm (parafuso M2) em 3,2 mm de diâmetro e os furos de 3 mm (parafuso M3) em 4,7 mm de diâmetro.

Foram também modeladas abraçadeiras em U para a fixação dos motores e das baterias, que possuem as dimensões dos componentes que aportam, com uma pequena folga de 1 mm em cada dimensão para margem de segurança, presas ao chassi com 4 parafusos M2 (2 mm de diâmetro por 12 mm de profundidade), também acompanhados dos insertos de latão. Foram também adicionadas pequenas paredes aos lados das baterias como precaução contra o deslizamento, assim como dois furos para passagem dos fios que vão para o chassi inferior.

A Figura \ref{fig:cad_iso} apresenta a vista isométrica do assembly do micromouse, na qual é possível observar as baterias de 3,7 V presas com uma abraçadeira no segundo nível e a separação entre os níveis.

\vspace{0.4in}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{figuras/rendermouse_isometrico.jpg}
    \caption{Vista isométrica do CAD do assembly domicromouse.}
    \label{fig:cad_iso}
\end{figure}

\vspace{0.15in}

A Figura \ref{fig:cad_superior} mostra a vista superior do primeiro nível do micromouse, na qual são identificados a placa de componentes eletrônicos: o microcontrolador ESP32, a ponte H TB6612FNG, os sensores infravermelhos VL53L0X e o ultrassônico HC-SR04 e o giroscópio MPU-6050. Os sensores frontais estão posicionados de forma a cobrir as três direções de interesse para a navegação: frente, esquerda e direita, conforme requerido pelo algoritmo de flood-fill descrito na Seção 6.5. Além disso, pode-se identificar os dois motores N20, fixados por abraçadeiras em U e as rodas em seus respectivos eixos.

\vspace{0.15in}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{figuras/rendermouse_topview.jpg}
    \caption{Vista superior do primeiro nível do micromouse.}
    \label{fig:cad_superior}
\end{figure}

\vspace{0.13in}

O chassi e as abraçadeiras em U serão feitos com impressão 3D em filamento PETG, escolhido pelos benefícios proporcionados pela técnica, como a facilidade e agilidade de fabricação, a adaptação à geometrias personalizadas sem desperdício de material, assim como leveza, baixo custo e boa compatibilidade do material com as necessidades do projeto, como suportar cargas leves e resistir a perfurações.
Já a placa de componentes eletrônicos será confeccionada em fenolite e mergulhada em percloreto de ferro para a formação das trilhas dos circuitos.

A Figura \ref{fig:cad_drafting} mostra as cotas e dimensões estabelecidas para o micromouse, assim como a indicação da posição de cada componente.
\begin{landscape} 
\begin{figure}[H]
    \centering
    \includegraphics[width=0.86\linewidth]{figuras/micromouse_drafting_jpg.jpg}
    \caption{Drafting do CAD do assembly do micromouse.}
...
O microcontrolador inicialmente selecionado foi o Raspberry Pi Pico W, em razão de seu bom 
desempenho de processamento, ampla documentação disponível na literatura e, 
principalmente, pela conectividade nativa Wi-Fi \cite{feitosa2025}. Contudo, a placa sofreu
um curto-circuito durante o desenvolvimento do projeto e foi substituída pelo ESP32,
que preserva os critérios que motivaram a escolha original: processamento
\textit{dual-core}, ampla documentação e conectividade Wi-Fi nativa, neste caso
integrada ao próprio chip.
...
%=========================================================================================    
    ...
    No firmware, será utilizada a linguagem C++17 com o framework ESP-IDF, da Espressif, que integra nativamente o FreeRTOS e o cliente MQTT (ESP-MQTT). Os drivers de baixo nível serão implementados em C, seguindo o padrão C99, com cabeçalhos C consumidos pelo firmware em C++. O broker MQTT será implementado com Eclipse Mosquitto em Docker. O backend será desenvolvido em Python 3.14, utilizando Django 6, Django REST Framework, Celery com Redis para o worker subscriber MQTT, a biblioteca httpx e gerenciamento por uv. O frontend será desenvolvido em TypeScript com modo strict, usando React 19, Vite, Mantine v9, TanStack Query v5, React Router v7 e gerenciamento por pnpm. A autenticação será baseada em JWT, com djangorestframework-simplejwt, e o banco de dados será PostgreSQL 18, aproveitando suporte nativo a UUID v7.
    ...
    Na visão de processos, descreve-se como os componentes lógicos são realizados em tasks, threads ou processos em tempo de execução, considerando seus períodos, prioridades e mecanismos de sincronização. No firmware embarcado, o ESP32 possui dois núcleos Xtensa LX6, identificados como Core 0 (PRO\_CPU) e Core 1 (APP\_CPU). Como decisão de projeto, a carga é distribuída de modo que o Core 1 execute as tarefas de tempo real, incluindo aquisição de sensores, algoritmo de navegação flood-fill e uma ISR de timer dedicada ao controle dos motores, com frequência entre 1 e 5 kHz, ainda a calibrar. O uso de ISR para o controle isola essa rotina do scheduler do FreeRTOS, garantindo frequência fixa. Já o Core 0 executa as tarefas de comunicação, incluindo a stack Wi-Fi nativa do chip — seguindo a convenção do próprio ESP-IDF, que aloca as tarefas de rede nesse núcleo —, o cliente MQTT publisher e a tarefa de telemetria. Essa separação isola o caminho crítico de controle das latências variáveis da comunicação sem fio.
